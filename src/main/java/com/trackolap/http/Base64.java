...
public class Base64 {
     ...
     * possible, though silly, to specify ORDERED and URL_SAFE in which case one of them will be picked,
     ...
     * 
     * <p>
     * As of v 2.3, if the object cannot be serialized or there is another error, the method will throw
     * an java.io.IOException. <b>This is new to v2.3!</b> In earlier versions, it just returned a null
     ...
     * instantiating a String. This is more efficient if you're working with I/O streams and have large
     * data sets to encode.
     * 
     * 
     * @param source The data to convert
    ...
    /**
     * Low-level access to decoding ASCII characters in the form of a byte array. <strong>Ignores GUNZIP
     * option, if it's set.</strong> This is not generally a recommended method, although it is used
     * internally as part of the decoding process. Special case: if len = 0, an empty array is returned.
     * Still, if you need more speed and reduced memory footprint (and aren't gzipping), consider this
     * method.
     * 
     ...
     * 
     * <p>
     * As of v 2.3, if there is a error, the method will throw an java.io.IOException. <b>This is new to
     * v2.3!</b> In earlier versions, it just returned false, but in retrospect that's a pretty poor way
     * to handle it.
     * </p>
     * 
